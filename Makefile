...
OBJS = src/geodesk_fdw.o src/geodesk_connection.o src/geodesk_lwgeom_builder.o src/geodesk_ring_assembler.o src/geodesk_options.o src/goql_converter.o src/type_filter.o
